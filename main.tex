...
email address}
\and
\IEEEauthorblockN{Yunfei Feng\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\textit{Global Data} \\
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=7cm,scale=0.8]{img/flower}}
\caption{Example of a figure caption.}
\label{fig:image_flower}
\end{figure}
...
``Temperature/K'', shown in the Fig. ~\ref{fig:image_flower}.
...
that have been accepted for publication should be cited as ``in press'' \cite{NBERw17126}.
Capitalize only the first word in a paper title, except for proper nouns and
element symbols.

For papers published in translation journals, please give the English
citation first, followed by the original foreign-language citation \cite{darknet13}.
